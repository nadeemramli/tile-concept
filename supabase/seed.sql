...
begin
  ...
  insert into core.saved_views (workspace_id, user_id, surface, name, filters, position, is_default) values
    ...
    (ws, null, 'inbox', 'Waiting for reply', '{"status":["contact_attempted"]}', 2, false),
    (ws, null, 'inbox', 'Contacted', '{"status":["contacted"]}', 3, false),
    (ws, null, 'inbox', 'Unassigned', '{"owner":"unassigned"}', 4, false),
    (ws, null, 'inbox', 'My leads', '{"owner":"me"}', 5, false),
    (ws, null, 'inbox', 'No response', '{"status":["new"],"first_response":"none"}', 6, false),
    (ws, null, 'inbox', 'SLA overdue', '{"follow_up":"due"}', 7, false),
    (ws, null, 'inbox', 'Duplicate review', '{"duplicates":true}', 8, false),
    (ws, null, 'inbox', 'Qualified', '{"status":["qualified","converted"]}', 9, false),
    (ws, null, 'inbox', 'Disqualified', '{"status":["disqualified"]}', 10, false),
    (ws, null, 'inbox', 'All', '{}', 11, false),
    (ws, null, 'inbox', 'Follow-ups due', '{"task_follow_up":"due"}', 12, false),
