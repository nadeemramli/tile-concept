...
export const walkInSchema = z.object({
  ...
  renovation_area: z.string().trim().max(200).optional().or(z.literal("")),
  inquiry_source: z.string().trim().max(40).optional().or(z.literal("")),
  purpose: z.enum(VISIT_PURPOSES),
  quotation_ref: z.string().trim().max(100).optional().or(z.literal("")),
  quotation_amount: z.coerce.number().nonnegative().nullable().default(null),
...
export const importRowSchema = z.object({
  ...
  renovation_area: z.string().optional().or(z.literal("")),
  orc_number: z.string().optional().or(z.literal("")),
  amount: z.number().nonnegative().nullable(),
  quotation_ref: z.string().optional().or(z.literal("")),
  quotation_amount: z.number().nonnegative().nullable().default(null),
