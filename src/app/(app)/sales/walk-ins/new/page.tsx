...
export default async function NewWalkInPage() {
  ...
  return (
    <PageBody className="max-w-3xl">
      <PageHeader title="New walk-in" description="Find a customer by telephone, company or PIC, capture the visit, then record a sale or payment against its document." />
