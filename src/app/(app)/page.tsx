        ...
        <>
          ...
          <section className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-1.5 md:grid-cols-3 xl:grid-cols-7">
              ...
              <MetricCard compact label="Lead follow-ups due" value={summary.lead_followups_due} hint="Due today or overdue" tone={summary.lead_followups_due ? "warning" : "neutral"} href="/sales/inbox?view=follow-ups-due" info={{ definition: "Leads with an open follow-up task due today or overdue (Asia/Kuala_Lumpur).", grain: "Lead", source: "sales.tasks", freshness }} />
